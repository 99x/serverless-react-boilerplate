...
gulp.task('start-offline-server', function (done) {
  runCommand('cd api ' + commandSeparator + 'cd todo ' + commandSeparator + 'serverless offline start', done);
});
...
gulp.task('serve', gulpSequence(['start-offline-server', 'start-client']));