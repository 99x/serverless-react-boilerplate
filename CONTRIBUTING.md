# Contributing to Serverless React Boilerplate
...
Bugs are tracked as [GitHub issues](https://guides.github.com/features/issues/). After you've determined where your bug is related to, create an issue on that [repository](https://github.com/99xt/serverless-react-boilerplate/issues) and provide the following information by filling in [the template](ISSUE_TEMPLATE.md).
...
```
$ git clone https://github.com/99xt/serverless-react-boilerplate.git
$ cd path-to-package/
```
